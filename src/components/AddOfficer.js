    ...
    render() {
       const { classes } = this.props;
        const handleSubmit = event => {
          ...
          const designationn=this.designation.value
          const usernamee=this.username.value
          const passwordd=this.password.value

          this.props.createOfficer(namee, CNICC, designationn ,usernamee, passwordd)
        ...
        <My_Icon className={classes.container} /> 
            ...
            <TextField 
                ...
                type="text"
                className={classes.textField}
                inputRef={el => this.designation = el}
                margin="normal"
                variant="outlined"
            />
            <TextField 
