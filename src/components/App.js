                    ...
                    <Switch>
                     <Route path="/" exact
                        render={(routeProps) => (<HomePage {...routeProps}
                          ...
                          Marker_Lat_long={this.state.Marker_Lat_long}
